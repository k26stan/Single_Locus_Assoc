...
for (chrom in 1:24) {
  ...
  abline(-log10(.05/mean(SNP_Cnt)),0, col="grey50", lty=3)
  text(0,-log10(.05/mean(SNP_Cnt))+.12, labels="Bonferroni",col="grey50")
  abline(-log10(5e-8),0, col="black", lty=3)
  text(0,-log10(5e-8)+.12, labels="p=5e-8", col="black")
dev.off()
...
jpeg( paste(PathToAssoc, "/QQ_Plot_",Pheno,"_",Covars,".jpeg", sep=""), height=1000, width=1000 )
